    ...
    <CalculatorLayout
      ...
      educationalContent={
        <div className="card prose prose-sm max-w-none">
          <h2>How Credit Card Payoff Works</h2>
          <p>
            Credit cards charge high interest rates (often 18-25% APR), making minimum payments
            a costly long-term strategy. This calculator shows how increasing your monthly payment
            can dramatically reduce both your payoff time and total interest paid.
          </p>
