    ...
    <CalculatorLayout
      ...
      educationalContent={
        <div className="card prose prose-sm max-w-none">
          <h2>How Savings Grow</h2>
          <p>
            Savings grow through regular deposits and compound interest. The more you save and the
            longer you wait, the more your money grows. This calculator shows exactly how your
